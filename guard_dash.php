...
<?php
                ...
                if ($designation == "E" && $row['forwarded_to'] == $cpf_no && $row['coll_approval'] == 0 && $row['security_approval'] != -1 && $row['guard_approval'] != -1) {
                    ...
                    echo '<button type="submit" name="receivebtn" class="btn btn-outline-secondary" value="' . $row['orderno'] . '">Receive</button>';
                    echo '</td>';
                } 
                    ...
                    echo '<td>';
                    echo '<input type="hidden" name="Orderno" value="' . $row['orderno'] . '">';
                    echo '<button type="submit" name="receivebtn" class="btn btn-outline-secondary" value="' . $row['orderno'] . '">Final Receive</button>';
                    echo '</td>';
                }
